      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormField label="Full Name" error={errors.full_name?.message}>
            <input {...register('full_name')} placeholder="Jane Doe" className={inputCls} />
          </FormField>
          ...
          <FormField label="Dietary Restrictions" error={errors.dietary_restrictions?.message}>
            <textarea
          ...
          <FormField label="Favourite Cuisine" error={errors.favourite_cuisine?.message}>
            <input {...register('favourite_cuisine')} placeholder="e.g. Italian, Thai…" className={inputCls} />
          </FormField>
